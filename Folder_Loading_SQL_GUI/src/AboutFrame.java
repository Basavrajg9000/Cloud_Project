...
class AboutFrame
{
  ...
  public AboutFrame()
  {
    ...
    space2=new JLabel("");
 	...
 	lbl1= new JLabel("1) Aditi Pawar");           // Create Name
	lbl2= new JLabel("2) Rani Pawar");          // template of student and
	lbl3= new JLabel("3) Vaishnavi Jadhav");        // guide
    lbl4= new JLabel("   ** Guided By **");
    lbl5= new JLabel("Mrs.S.S.Jogdand");
